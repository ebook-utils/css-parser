...
class CSSParserTestCase(basetest.BaseTestCase):
    ...
    def test_init(self):
        ...
        self.assertRaises(xml.dom.DOMException, s.__setattr__, u'cssText',
                          u'$')
    ...
    def test_parseString(self):
        ...
        tests = {
            ...
            # new for 2.x and 3.x
            (u'/*\xe4*/'.encode('utf-8'), None): (u'utf-8',
                                                  u'/*\xe4*/'.encode('utf-8')),
            (u'/*\xe4*/'.encode('utf-8'), 'utf-8'):
    ...
    def test_fetcher(self):
        ...
        tests = {
            ...
            (u'@charset "utf-16"; @import "x";', 'ASCII', ('iso-8859-1', u'@charset "latin1";/*t*/')):
            ('ascii', 1, 'ascii', u'@charset "ascii";\n/*t*/'.encode()),
            # 1/1 not tested her but same as next
            # 2/1 @charset/HTTP => UTF-16/ISO-8859-1
            (u'@charset "UTF-16"; @import "x";', None, ('ISO-8859-1', u'@charset "latin1";/*t*/')):
            ('utf-16', 1, 'iso-8859-1',
             u'@charset "iso-8859-1";\n/*t*/'.encode('iso-8859-1')),
            # 2/2 @charset/@charset => UTF-16/ISO-8859-1
            (u'@charset "UTF-16"; @import "x";', None, (None, u'@charset "ISO-8859-1";/*t*/')):
            ('utf-16', 1, 'iso-8859-1',
             u'@charset "iso-8859-1";\n/*t*/'.encode('iso-8859-1')),
            ...
            ('@import "x";', None, (None, u'/*t*/')): ('utf-8', 0, 'utf-8',
                                                       u'/*t*/'.encode()),
            # 0/0 override/override+unicode
            ('@charset "utf-16"; @import "x";', 'ASCII', (None, u'@charset "latin1";/*\u0287*/')):
            ('ascii', 1, 'ascii', u'@charset "ascii";\n/*\\287 */'.encode()),
...
/* \E4  */'''
    ...
    def test_invalidstring(self):
        ...
        csss = (u'''@charset "ascii
                ;''' + validfromhere, u'''@charset 'ascii
                ;''' + validfromhere, u'''@namespace "y
                ;''' + validfromhere, u'''@import "y
                ;''' + validfromhere, u'''@import url('a
                );''' + validfromhere, u'''@unknown "y
                ;''' + validfromhere)
        for css in csss:
...
a {
    color: green
            ...
            u'p @here {color: red} p {color: green}':
            u'p {\n    color: green\n    }'
        }
    ...
    a[title="a not s\
o very long title"] {/*...*/}''':
            u'''a[title="a not so very long title"] {
    /*...*/
    }'''
        }
        for css in tests:
